...
def plot_histogram_with_large_font(ax, cutoff, data, x_limit_min, x_limit_max, y_limit):
    filtered_data_exact = data[data['tw3'] == cutoff]
    ax.hist(filtered_data_exact['total_$'], bins=20, color='skyblue', edgecolor='black', alpha=0.7)
...
axes[0].set_title('tw_0 = 60 Days', fontsize=22)
axes[1].set_title('tw_0 = 80 Days', fontsize=22)
axes[2].set_title('tw_0 = 100 Days', fontsize=22)
axes[3].set_title('tw_0 = 120 Days', fontsize=22)
